...
supabase.auth.onAuthStateChange((event, session) => {
  ...
  if (user) {
    ...
    const protectedPaths = ['/chat', '/chat.html', '/profile.html', '/settings.html', '/index.html', '/admin', '/admin.html'];
    if (protectedPaths.includes(path)) window.location.href = '/login.html';
  }
});
