...
function startPersonalChat(user) {
  ...
  contactItem.onclick = () => {
    ...
    if (chatMessages) {
      ...
      const msgDiv = Object.assign(document.createElement('div'), { className: 'message received', textContent: `Hi! This is the start of your personal chat with ${user.full_name}. ` });
      msgDiv.appendChild(Object.assign(document.createElement('span'), { className: 'message-time', textContent: 'Just now' }));
      chatMessages.appendChild(msgDiv);
    }
